    ...
    <div class="col" style='margin:15px 0;'>
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-footer">
                <small class="text-muted" style="padding-bottom: 15px; display: inline-block;">Creado: {{ preFecha(video.fecha) }}</small>
                ...
                <button type="button" class="btn btn-outline-primary float-end" @click="preVideo()">
